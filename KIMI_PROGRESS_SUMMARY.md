...
- 女主定位分级已收紧：高频出场、重要度排序或参与主线案件只能证明角色重要，不能单独抬成强准女主；没有明确恋爱、暧昧、后宫定位或漏女情感深度证据时，最多按弱准女主展示，并过滤“没有恋爱/未确认关系”等否定句里的误触发关键词。
...
最近全量验证结果：`python3 -m unittest discover -s tests -v` 通过，当前为 **103 个测试 OK**。

...
_VALIDATED_NON_NEGATIVE_INT_KEYS = {
    ...
    "HAREM_SCAN_CHUNK_SIZE": _DEFAULT_ENV_SETTINGS["HAREM_SCAN_CHUNK_SIZE"],
    "HAREM_SCAN_MAX_TOKENS": _DEFAULT_ENV_SETTINGS["HAREM_SCAN_MAX_TOKENS"],
    "HAREM_SCAN_RETRY_WORKERS": _DEFAULT_ENV_SETTINGS["HAREM_SCAN_RETRY_WORKERS"],
    "HAREM_SCAN_API_DOWNSHIFT_MAX_DEPTH": _DEFAULT_ENV_SETTINGS["HAREM_SCAN_API_DOWNSHIFT_MAX_DEPTH"],
    "HAREM_SCAN_API_DOWNSHIFT_MIN_CHARS": _DEFAULT_ENV_SETTINGS["HAREM_SCAN_API_DOWNSHIFT_MIN_CHARS"],
    "GENERAL_SCAN_MAX_CHUNKS": _DEFAULT_ENV_SETTINGS["GENERAL_SCAN_MAX_CHUNKS"],
    "GENERAL_SCAN_CONTEXT_MAX_CHARS": _DEFAULT_ENV_SETTINGS["GENERAL_SCAN_CONTEXT_MAX_CHARS"],
    "RESCAN_ROUNDS": _DEFAULT_ENV_SETTINGS["RESCAN_ROUNDS"],
    "MAX_MIDDLE_SUMMARY_CALLS": _DEFAULT_ENV_SETTINGS["MAX_MIDDLE_SUMMARY_CALLS"],
    "INITIAL_SCAN_BLOCK_MULTIPLIER": _DEFAULT_ENV_SETTINGS["INITIAL_SCAN_BLOCK_MULTIPLIER"],
    "INITIAL_SCAN_MIN_BLOCK_SIZE": _DEFAULT_ENV_SETTINGS["INITIAL_SCAN_MIN_BLOCK_SIZE"],
    ...
    "RESCAN_SKIP_CHRONIC_PARSE_FAILURE_AFTER": _DEFAULT_ENV_SETTINGS["RESCAN_SKIP_CHRONIC_PARSE_FAILURE_AFTER"],
    "LOG_MAX_BYTES": _DEFAULT_ENV_SETTINGS["LOG_MAX_BYTES"],
    "LOG_BACKUP_COUNT": _DEFAULT_ENV_SETTINGS["LOG_BACKUP_COUNT"],
}
_VALIDATED_NON_NEGATIVE_FLOAT_KEYS = {
    "RESCAN_PRE_FILTER_THRESHOLD": _DEFAULT_ENV_SETTINGS["RESCAN_PRE_FILTER_THRESHOLD"],
    "SCAN_STALL_TIMEOUT_SECONDS": _DEFAULT_ENV_SETTINGS["SCAN_STALL_TIMEOUT_SECONDS"],
    "SCAN_FUTURE_STALL_TIMEOUT_SECONDS": _DEFAULT_ENV_SETTINGS["SCAN_FUTURE_STALL_TIMEOUT_SECONDS"],
...
def load_configs(base_dir, interactive=True):
    ...
    print(
        f"后宫首扫降载：HAREM_SCAN_CHUNK_SIZE={os.environ['HAREM_SCAN_CHUNK_SIZE']}  "
        f"HAREM_SCAN_MAX_TOKENS={os.environ['HAREM_SCAN_MAX_TOKENS']}  "
        f"HAREM_SCAN_RETRY_WORKERS={os.environ['HAREM_SCAN_RETRY_WORKERS']}  "
        f"API_SERVER_ERROR_MAX_RETRIES={os.environ['API_SERVER_ERROR_MAX_RETRIES']}  "
        f"API_SERVER_ERROR_FAST_FAIL_INPUT_CHARS={os.environ['API_SERVER_ERROR_FAST_FAIL_INPUT_CHARS']}"
    )
    print(
        ...
        f"RESCAN_SKIP_CHRONIC_PARSE_FAILURE_AFTER={os.environ['RESCAN_SKIP_CHRONIC_PARSE_FAILURE_AFTER']}"
    )
    print(

...
EDITABLE_RUNTIME_CONFIG = {
    ...
    "json_fallback_max_tokens": {"env": "JSON_FALLBACK_MAX_TOKENS", "type": "int", "min": 200, "max": 8000},
    ...
    "review_llm_section_max_chars": {"env": "REVIEW_LLM_SECTION_MAX_CHARS", "type": "int", "min": 2000, "max": 100000},
    "review_llm_field_max_chars": {"env": "REVIEW_LLM_FIELD_MAX_CHARS", "type": "int", "min": 40, "max": 5000},
    "review_llm_list_max_items": {"env": "REVIEW_LLM_LIST_MAX_ITEMS", "type": "int", "min": 5, "max": 1000},
    "report_llm_section_max_chars": {"env": "REPORT_LLM_SECTION_MAX_CHARS", "type": "int", "min": 2000, "max": 100000},
    "report_llm_field_max_chars": {"env": "REPORT_LLM_FIELD_MAX_CHARS", "type": "int", "min": 40, "max": 5000},
    "report_llm_list_max_items": {"env": "REPORT_LLM_LIST_MAX_ITEMS", "type": "int", "min": 5, "max": 1000},
    ...
    "general_character_parse_downshift_retry": {"env": "GENERAL_CHARACTER_PARSE_DOWNSHIFT_RETRY", "type": "int", "min": 0, "max": 10},
...
def _runtime_config_summary():
    ...
    return {
        ...
        "json_fallback_max_tokens": os.environ.get("JSON_FALLBACK_MAX_TOKENS", "1200"),
        ...
        "review_llm_section_max_chars": os.environ.get("REVIEW_LLM_SECTION_MAX_CHARS", "12000"),
        "review_llm_field_max_chars": os.environ.get("REVIEW_LLM_FIELD_MAX_CHARS", "220"),
        "review_llm_list_max_items": os.environ.get("REVIEW_LLM_LIST_MAX_ITEMS", "80"),
        "report_llm_section_max_chars": os.environ.get("REPORT_LLM_SECTION_MAX_CHARS", "12000"),
        "report_llm_field_max_chars": os.environ.get("REPORT_LLM_FIELD_MAX_CHARS", "180"),
        "report_llm_list_max_items": os.environ.get("REPORT_LLM_LIST_MAX_ITEMS", "40"),
        ...
        "general_character_parse_downshift_retry": os.environ.get("GENERAL_CHARACTER_PARSE_DOWNSHIFT_RETRY", "1"),
